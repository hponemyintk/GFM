#!/usr/bin/env bash
# rel-f1 driver-top3, K=20, 30 epochs, 20 seeds, both branches — RESUME from seed 6.
# devkyaw s0-s5 and ogpass s0-s5 already complete; s6 devkyaw dir exists but has no result json.
